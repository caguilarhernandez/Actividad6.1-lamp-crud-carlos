...
//Consulta de selección. Selecciona todas las comidas ordenados de manera descendente por el campo id
$result = mysqli_query($mysqli, "SELECT * FROM comidas ORDER BY id DESC");
...
<div>
	...
	<ul>
		...
		<li><a href="add.html">Comidas</a></li>
	</ul>
...
//Genera la tabla de la página inicial
	while($res = mysqli_fetch_array($result)) {
		...
		echo "<td>".$res['tipocomida']."</td>\n";
		echo "<td>".$res['cuandocomer']."</td>\n";
		echo "<td>".$res['paiscreacion']."</td>\n";
		echo "<td>".$res['paisauge']."</td>\n";
		echo "<td>";
